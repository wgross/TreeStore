...
{
    public class KosmographContainerCmdletProviderTest : TreeStoreCmdletProviderTestBase
    {
        ...
        public void PowerShell_copies_Entity_to_Category()
        {
            ...
            this.EntityRepositoryMock
                .Setup(r => r.Upsert(It.IsAny<Entity>()))
                .Callback<Entity>(e => copiedEntity = e)
                .Returns<Entity>(e => e);
            ...
            Assert.False(this.PowerShell.HadErrors);
            Assert.Empty(result);
            Assert.Equal(entity.Name, copiedEntity.Name);
            Assert.NotEqual(entity.Id, copiedEntity.Id);
        }
